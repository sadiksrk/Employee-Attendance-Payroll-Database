...
CREATE TABLE `salary_structure` (
  ...
  PRIMARY KEY (`emp_id`),
  CONSTRAINT `salary_structure_ibfk_1` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`emp_id`)
...
INSERT INTO `salary_structure` VALUES (1,5000.00,3000.00,2000.00),(2,8000.00,5000.00,3000.00),(3,6000.00,4000.00,2500.00);
...
-- Dump completed on 2026-01-09 21:06:32
